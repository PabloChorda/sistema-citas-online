...
export default function DashboardLayout({ me: meProp, handleLogout }) {
  ...
  return (
    // 🔶 Envolvemos TODO en una columna para poder mostrar el banner arriba del todo
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' }}>
      {/* Banner de demo a lo ancho */}
      <DemoBanner />
      ...
      <div style={{ display: 'flex', flex: 1, backgroundColor: '#f9fafb' }}>
        ...
        <aside
          ...
          style={{
            ...
            position: 'sticky',
            top: 0,
            height: 'calc(100dvh - 0px)', // banner ocupa su propia altura arriba
